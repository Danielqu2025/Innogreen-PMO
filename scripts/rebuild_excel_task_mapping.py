...
RULES: list[tuple[tuple[str, ...], tuple[str, ...], str, str]] = [
    ...
    (("安评", "安全预评价", "反应安全"), ("化工反应", "反应安全风险", "反应风险评估"), "3.2.1", "安评-化工反应安全风险评估"),
    (("安评", "安全预评价"), ("报告编制", "编制定稿"), "3.2.2", "安评-报告编制"),
    (("安评", "安全预评价"), ("报告审批", "内部专家", "内部审批"), "3.2.3", "安评-报告审批"),
    (("安评", "安全", "安设"), ("专篇编制",), "3.2.4", "安设专篇编制"),
    (("安评", "安全", "安设"), ("专篇审批", "专篇备案", "内部专家"), "3.2.5", "安设专篇审批"),
    (("安评", "安全", "工艺审批"), ("安监处设计审查", "安全条件", "安监处进行"), "3.2.6", "安全条件/安监审查"),
    (("环评", "环境"), ("报告编制",), "3.3.1", "环评-报告编制"),
    (("环评", "环境"), ("报告审批", "内部审批"), "3.3.2", "环评-报告审批"),
    (("环评", "环境"), ("市局公示", "公示、审批", "公示审批"), "3.3.3", "环评-市局"),
    (("职评", "职业", "卫评", "职卫"), ("报告编制", "评价报告"), "3.4.1", "职评-报告编制"),
    (("职评", "职业", "卫评"), ("报告审批", "内部审批"), "3.4.2", "职评-报告审批"),
    (("职评", "职业", "卫评"), ("专篇编制",), "3.4.3", "职评专篇编制"),
    (("职评", "职业", "卫评"), ("专篇审批", "专篇备案"), "3.4.4", "职评专篇备案"),
    (("试生产",), ("方案编制", "编制定稿"), "7.1.1", "试生产方案编制"),
    (("试生产",), ("内部专家", "方案内部"), "7.1.2", "试生产方案评审"),
    (("试生产",), ("安全评审", "安监处进行开工前"), "7.1.3", "试生产安全评审"),
    (("试生产",), ("启动", "开始试生产"), "8.1", "启动试生产"),
    (("试生产准备", "试生产"), ("试生产准备", "试生产"), "7.1", "试生产准备父任务"),
    (("三同时", "竣工验收", "正式投用"), ("安全竣工", "安全设施竣工"), "8.2.1", "安全三同时验收"),
    (("三同时", "竣工验收"), ("环保竣工", "环保验收", "环境保护验收"), "8.2.2", "环保验收"),
    (("三同时", "竣工验收"), ("职业卫生", "职业病防护"), "8.2.3", "职卫验收"),
    (("供应链", "危化"), ("确认技术方案", "技术方案"), "4.8.2", "危化品技术方案"),
    (("供应链", "危化"), ("签订服务合同", "服务合同"), "4.8.3", "危化品服务合同"),
    (("供应链", "危化"), ("签订意向书", "意向书"), "4.8.1", "危化品意向书"),
    (("供应链", "危化"), ("正式提供服务",), "4.8.4", "危化品服务"),
    (("危废",), ("签订处置合同", "处置合同", "签订危废"), "4.6.2", "危废处置合同"),
    (("能源", "冷热", "蒸汽"), ("签订", "能源供应", "供能"), "4.7.3", "能源供应协议"),
]
...
SIMPLE_LEAF = {
    ...
    "防雷设计审查": "5.2.3",
    "施工许可证": "5.3.1",
    "安全生产管控平台 （承包商安全备案）": "5.3.2",
    "安全生产管控平台（承包商安全准入备案）": "5.3.2",
    "施工前准备工作（安全技术交底、临时设施搭建等）": "6.1",
    "施工前准备工作（安全技术交底）": "6.1.1",
    "装修土建结构施工": "6.2.1",
    "现场装修施工": "6.2.1",
    "机电工程施工": "6.3.1",
    "机电设备安装施工": "6.3.1",
    ...
    "职业卫生验收": "8.2.3",
    "正式投用": "9.1",
    "签订意向书": "4.5.2",  # often sewage; may need context
    "安监处设计审查": "3.2.6",
    "化工反应安全风险评估": "3.2.1",
    "安监处进行开工前安全条件确认": "7.1.3",
    "专篇备案": "3.4.4",
}

# Utility service context → prefix mapping for 商务谈判/合同签订/正式提供服务
UTILITY_PARENT = {
    "咨询": ("4.1.1", "4.1.2", "4.1.3"),
    "物业": ("4.2.1", "4.2.2", "4.2.3"),
    "消防": ("4.3.1", "4.3.2", "4.3.3"),
    "环保": ("4.4.1", "4.4.2", "4.4.3"),
    "污水": ("4.5.1", "4.5.3", "4.5.4"),
    "危废": ("4.6.1", "4.6.2", "4.6.3"),
    "能源": ("4.7.1", "4.7.3", "4.7.4"),
    "冷热": ("4.7.1", "4.7.3", "4.7.4"),
    "蒸汽": ("4.7.1", "4.7.3", "4.7.4"),
    "危化": ("4.8.1", "4.8.3", "4.8.4"),
    "供应链": ("4.8.1", "4.8.3", "4.8.4"),
    "气体": ("4.9.1", "4.9.2", "4.9.3"),
}
...
def match_code(section: str, parent: str, leaf: str) -> tuple[str, str, str]:
    ...
    # 2) utility triad by parent type (before SIMPLE_LEAF — avoid 正式提供服务→9.1)
